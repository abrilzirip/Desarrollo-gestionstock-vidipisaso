...
const pantalla_principal = document.getElementById("template-pantalla-principal").innerHTML;
...
tocar_boton.addEventListener("click", e => {
    ...
    if (usuario === Hardusuario && password === Hardpassword) {
        ...
        document.getElementById("idContenedor").innerHTML = pantalla_principal;
...
const pintarFooter=()=>{
    ...
    if (Object.keys(carrito).lenght===0) {
        footer.innerHTML=`<th scope="row" colspan="5">Carrito Vacio - Comience a compara!</th>`;
        return ;
    }
