...
function validarForm() {
    ...
    for (let palabra of nombreArray) {
        if (palabra.length < 2 || palabra.length > 12) {
            nombreInput.classList.add("is-invalid");
            smsErrorNombre.innerHTML = "El campo Nombre solo acepta como minimo 2 caracteres y como maximo 12";
            return false;
        } else {
            nombreInput.classList.add("is-valid");
        }
    ...
    if (apellidoArray.length > 1) {
        apellidoInput.classList.add("is-invalid");
        smsErrorApellido.innerHTML = "El campo Apellido solo acepta una palabra";
        return false;
    }
    else {
        apellidoInput.classList.add("is-valid");
    ...
    for (palabra of apellidoArray) {
        if (palabra.length < 2 || palabra.length > 16) {
            apellidoInput.classList.add("is-invalid");
            smsErrorApellido.innerHTML = "El campo Nombre solo acepta como minimo 2 caracteres y como maximo 16";
            return false;
        } else {
            apellidoInput.classList.add("is-valid");
        }
    ...
    for (palabra of apodoArray) {
        if (palabra.length < 2 || palabra.length > 12) {
            apodoInput.classList.add("is-invalid");
            smsErrorApodo.innerHTML = "El campo Apodo solo acepta como minimo 2 caracteres y como maximo 12";
            return false;
        } else {
            apodoInput.classList.add("is-valid");
        }
    ...
    for (palabra of emailArray) {
        if (palabra.length < 25 || palabra.length > 30) {
            emailInput.classList.add("is-invalid");
            smsErrorEmail.innerHTML = "El campo Apodo solo acepta como minimo 25 caracteres y como maximo 30";
            return false;
        } else {
            emailInput.classList.add("is-valid");
        }
...
function mostrarModal() {
    ...
    textoModal.innerHTML = "Cliente Registrado"
