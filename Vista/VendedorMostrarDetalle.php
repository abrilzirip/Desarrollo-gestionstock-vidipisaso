                ...
                <div id="divMostrarOcultarDetallesCliente" class="mx-auto my-1 col-12">
                    <form id="frmModificarCliente" action="VendedorListaCliente.php" method="POST">
                        <div class="card bg-dark text-light">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="mx-auto mx-auto mb-3 col-xs-4 col-sm-12 col-md-4 col-lg-4" id="divFrmClienteID" disabled>
                                        <label for="frmClienteID" class="form-label">ID</label>
                                        <input type="number" class="form-control" id="frmClienteID" name="frmClienteID" />
                                        <div class="invalid-feedback" id="errorClienteID"></div>
                                    </div>
                                    <div class="mx-auto mx-auto mb-3 col-xs-4 col-sm-12 col-md-4 col-lg-4" id="divFrmClienteIDUsuarioRegistrado">
                                    ...
                                    <div class="mx-auto mx-auto mb-3 col-xs-4 col-sm-12 col-md-4 col-lg-4" id="divFrmClienteNombre">
                                        <label for="frmClienteNombre" class="form-label">Nombre</label>
                                        <input type="text" class="form-control" id="frmClienteNombre" name="frmClienteNombre" />
                                        <div class="invalid-feedback" id="errorClienteNombre"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mx-auto mx-auto mb-3 col-xs-4 col-sm-12 col-md-4 col-lg-4" id="divFrmClienteApellido">
                                        <label for="frmClienteApellido" class="form-label">Apellido</label>
                                        <input type="text" class="form-control" id="frmClienteApellido" name="frmClienteApellido" />
                                        <div class="invalid-feedback" id="errorClienteApellido"></div>
                                    </div>
                                    <div class="mx-auto mx-auto mb-3 col-xs-4 col-sm-12 col-md-4 col-lg-4" id="divFrmClienteApodo">
                                        <label for="frmClienteApodo" class="form-label">Apodo</label>
                                        <input type="text" class="form-control" id="frmClienteApodo" name="frmClienteApodo" />
                                        <div class="invalid-feedback" id="errorClienteApodo"></div>
                                    </div>
                                    <div class="mx-auto mx-auto mb-3 col-xs-4 col-sm-12 col-md-4 col-lg-4" id="divFrmClienteFechaAlta">
                                        <label for="frmClienteFechaAlta" class="form-label">Fecha de Alta</label>
                                        <input type="number" class="form-control" id="frmClienteFechaAlta" name="frmClienteFechaAlta" />
                                        <div class="invalid-feedback" id="errorClienteID"></div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="mx-auto mx-auto mb-3 col-xs-4 col-sm-12 col-md-12 col-lg-12" id="divFrmClienteFechaBaja">
                                        <label for="frmClienteFechaBaja" class="form-label">Fecha de Baja</label>
                                        <input type="number" class="form-control" id="frmClienteFechaBaja" name="frmClienteFechaBaja" />
                                        <div class="invalid-feedback" id="errorClienteID"></div>
                                    </div>
                                </div>
                            </div>
